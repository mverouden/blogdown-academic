...
### Download
At the time this post was written the latest release of R is version 4.0.3. It has been updated to the latest release version 4.2.0 of R.
...
1. Right-click the downloaded file **R-4.2.0patched-win.exe** and select 'WUR - Run with administrative rights'. This file will most likely reside in your Downloads folder of your user account.
...
4. Click on the ‘Next’ button to agree to the terms. After this a window will appear, allowing you to select or choose the destination folder, as shown below, where R 4.2.0 for Windows should be installed. Change the destination location to `C:\MyPrograms\R\R-4.2.0`, as shown in [Figure 11](#figure-install_r_destination) below, by typing the destination path directly into the text field displayed (currently showing `C:\Program Files\R\R-4.2.0`) . Click on the ‘Next’ button to continue.
