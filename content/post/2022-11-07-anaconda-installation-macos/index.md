...
## Download 
At the time this post was written, the latest release of Anaconda was version 2022.10 containing Python 3.9.13.<!-- It has been updated to the latest release version 2022.10 of Anaconda.-->
...
- For an Intel processor based mac: [{{< icon name="download" pack="fas" >}} Anaconda3 2022.10 (ca. 688MB, __Intel 64-bit__ build)](https://repo.anaconda.com/archive/Anaconda3-2022.10-MacOSX-x86_64.pkg)
- For an M1/M2 processor based mac: [{{< icon name="download" pack="fas" >}} Anaconda3 2022.10 (ca. 484MB, __ARM 64-bit__ build)](https://repo.anaconda.com/archive/Anaconda3-2022.10-MacOSX-arm64.pkg)

## Installation

For installing Anaconda on macOS follow these steps:

1. Open the downloaded file, either **Anaconda3-2022.10-MacOSX-x86_64.pkg**, or **Anaconda3-2022.10-MacOSX-arm64.pkg** depending on the processor in your mac (as explained above). This file will most likely reside in Finder > Downloads (shortcut: &#8997;&#8984;L). The file can more easily be found by switching into List view (shortcut: &#8984;2). To switch to Icon view use the shortcut: &#8984;1.
...
{{% callout note %}}
Congratulations :satisfied:, you now have Anaconda3 2022-10 containing Python 3.9.13 installed on your mac!
