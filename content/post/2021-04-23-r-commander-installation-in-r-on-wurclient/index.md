...
1. Start `R 4.6.1` from the ‘R’ folder in the ‘Start Menu’ as displayed below in [Figure 1](#figure-startmenu_r).
...
{{% callout note %}}
Once the installation of the `RcmdrPlugin.HH` package, or any other additional Plugins you require, has finished, you are ready :satisfied: to start R version 4.6.1 and use R Commander.
{{% /callout %}}
