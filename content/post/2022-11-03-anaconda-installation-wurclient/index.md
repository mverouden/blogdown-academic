...
1. Right-click the downloaded file **Anaconda3-2024.06-1-Windows-x86_64.exe** and select 'WUR - Run with administrative rights'. This file will most likely reside in your Downloads folder of your user account.
...
{{% callout note %}}
Congratulations, :satisfied:, you now have Anaconda3 version 2024.06-1 containing Python 3.12.4 installed on your WURclient desktop or laptop computer!
{{% /callout %}}
