...
## Download
At the time this post was written the latest stable release of RStudio was version 1.2.5033. It has been updated to the current stable release 2025.09.0 Build 387 (nicknamed "Cucumberleaf Sunflower"), which will work on macOS Ventura (version 13.x) or later.

Download RStudio using the following link: [{{< icon name="download" pack="fas" >}} RStudio 2025.09.0 Build 387 (ca. 634.56 MB)](https://download1.rstudio.org/electron/macos/RStudio-2025.09.0-387.dmg)
