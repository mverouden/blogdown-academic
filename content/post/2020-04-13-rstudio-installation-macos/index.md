...
## Download
At the time this post was written the latest stable release of RStudio was version 1.2.5033. It has been updated to the current stable release 2023.06.0 Build 421, which will work on macOS Big Sur (version 11.x) or later.

Download RStudio using the following link: [{{< icon name="download" pack="fas" >}} RStudio 2023.06.0 Build 421 (ca. 380.07 MB)](https://download1.rstudio.org/electron/macos/RStudio-2023.06.0-421.dmg)
