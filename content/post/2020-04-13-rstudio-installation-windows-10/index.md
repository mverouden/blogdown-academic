...
### Download
At the time this post was written, the latest stable release of RStudio wass version 1.2.5033. The post has been updated to the current stable release version 2022.07.2 Build 576 (named "Spotted Wakerobin").
...
1. Open the downloaded file **RStudio-2022.07.2-576.exe**. This file will most likely reside in the Downloads folder of your user account.
