...
### Download
At the time this post was written, the latest stable release of RStudio wass version 1.2.5033. The post has been updated to the current stable release version 2022.07.1 Build 554 (named "Spotted Wakerobin").
...
{{% callout note %}}
Congratulations, :satisfied:, you now have RStudio 2022.07.1 Build 554 installed on your private Windows 10 desktop or laptop computer!
{{% /callout %}}
