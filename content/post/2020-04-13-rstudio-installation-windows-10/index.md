...
### Download
At the time this post was written, the latest stable release of RStudio wass version 1.2.5033. The post has been updated to the current stable release version 2022.12.0 Build 353 (named "Elsbeth Geranium").
...
1. Open the downloaded file **RStudio-2022.12.0-353.exe**. This file will most likely reside in the Downloads folder of your user account.
...
{{% callout note %}}
Congratulations, :satisfied:, you now have RStudio 2022.12.0 Build 353 installed on your private Windows desktop or laptop computer!
{{% /callout %}}
