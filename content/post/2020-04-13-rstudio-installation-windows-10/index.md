...
1. Open the downloaded file **RStudio-2025.09.1-401.exe**. This file will most likely reside in the Downloads folder of your user account.
...
{{% callout note %}}
Congratulations, :satisfied:, you now have RStudio 2025.09.1 Build 401 installed on your private Windows desktop or laptop computer!
{{% /callout %}}
