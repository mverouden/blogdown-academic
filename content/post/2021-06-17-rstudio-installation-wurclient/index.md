...
Many users, however, prefer to use the latest version of RStudio, because of new features offered in the newer version of the software. At the moment of writing this post the latest version of RStudio was v1.4.1717 named: 'Juliet Rose' (released on 2021-06-01). The post has been updated, with the exception of the screenshots, to `RStudio 2024.04.0 Build 735` named: "Chocolate Cosmos".
...
{{% callout note %}}
Congratulations, :satisfied:, you now have RStudio 2024.04.0 Build 735 installed on your WURclient desk- or laptop computer!
{{% /callout %}}
