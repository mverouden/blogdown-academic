...
summary: "Instructions on how to install RStudio yourself on a WURclient without using Software Center/WURAppStore."
...
Many users, however, prefer to use the latest version of RStudio, because of new features offered in the newer version of the software. At the moment of writing this post the latest version of RStudio was v1.4.1717 named: 'Juliet Rose' (released on 2021-06-01). The post has been updated, with the exception of the screenshots, to `RStudio 2026.04.0 Build 526` named: "Globemaster Allium".
...
{{% callout warning %}}
The installation instructions in this post are <u>**not to be used on privately owned desktops or laptops**</u>! For a privately owned desktop or laptop see the post: [RStudio installation on Windows 10/11](/post/2020/04/13/rstudio-installation-on-windows-10/).
{{% /callout %}}
...
### Download
At the time this post was written, the latest stable release of RStudio was version 1.4.1717. The post has been updated to the current stable release 2026.04.0 Build 526.

Download RStudio using the following link: [{{< icon name="download" pack="fas" >}} RStudio 2026.04.0 Build 526 (ca. 319.84 MB)](https://download1.rstudio.org/electron/windows/RStudio-2026.04.0-526.exe)
...
1. Right-click the downloaded file **RStudio-2026.04.0-526.exe** and select 'WUR - Run with administrative rights'. This file will most likely reside in your Downloads folder of your user account.
...
{{% callout note %}}
Congratulations, :satisfied:, you now have RStudio 2026.04.0 Build 526 installed on your WURclient desk- or laptop computer!
{{% /callout %}}
