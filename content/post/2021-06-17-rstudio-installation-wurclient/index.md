...
### Download
At the time this post was written, the latest stable release of RStudio was version 1.4.1717. The post has been updated to the current stable release 2023.03.1 Build 446.

Download RStudio using the following link: [{{< icon name="download" pack="fas" >}} RStudio 2023.03.1 Build 446 (ca. 208.07 MB)](https://download1.rstudio.org/electron/windows/RStudio-2023.03.1-446.exe)
...
1. Right-click the downloaded file **RStudio-2023.03.1-446.exe** and select 'WUR - Run with administrative rights'. This file will most likely reside in your Downloads folder of your user account.
...
{{% callout note %}}
Congratulations, :satisfied:, you now have RStudio 2023.03.1 Build 446 installed on your WURclient desk- or laptop computer!
{{% /callout %}}
