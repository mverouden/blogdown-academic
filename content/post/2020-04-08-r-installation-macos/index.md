...
## Download 
At the time this post was written, the latest release of R was version 3.6.3. It has been updated to the latest release version 4.6.1 of R (nicknamed: "Happy Hop") for macOS Sonoma (macOS 14) or higher.
...
- For macOS Big Sur (11.x) and higher (__Intel 64-bit__ build): [{{< icon name="download" pack="fas" >}} R 4.6.1  (ca. 104 MB, *notarized and signed* __Intel 64-bit__ build)](https://cloud.r-project.org/bin/macosx/big-sur-x86_64/base/R-4.6.1-x86_64.pkg)
- For macOS Sonoma (14.x) and higher (__Apple silicon arm64__ build for M1, M2, M3, or M4 processor MACS only): [{{< icon name="download" pack="fas" >}} R 4.6.1  (ca. 101 MB, *notarized and signed* __ARM 64-bit__ build)](https://cloud.r-project.org/bin/macosx/sonoma-arm64/base/R-4.6.1-arm64.pkg) <!--Due to an error in the release for the Apple silicon arm64 build, use the above download for the Intel 64-bit version!-->
