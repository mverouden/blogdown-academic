...
## Download 
At the time this post was written, the latest release of R was version 3.6.3. It has been updated to the latest release version 4.3.3 of R (nicknamed: "Angel Food Cake") for macOS Big Sur or higher.
...
- For macOS Big Sur (11.x) and higher (__Intel 64-bit__ build): [{{< icon name="download" pack="fas" >}} R 4.3.3  (ca. 94 MB, *notarized and signed* __Intel 64-bit__ build)](https://cloud.r-project.org/bin/macosx/big-sur-x86_64/base/R-4.3.3-x86_64.pkg)
- For macOS Big Sur (11.x) and higher (__Apple silicon arm64__ build for M1 or M2 processor MACS only): [{{< icon name="download" pack="fas" >}} R 4.3.3  (ca. 92 MB, *notarized and signed* __ARM 64-bit__ build)](https://cloud.r-project.org/bin/macosx/big-sur-arm64/base/R-4.3.3-arm64.pkg) <!--Due to an error in the release for the Apple silicon arm64 build, use the above download for the Intel 64-bit version!-->
