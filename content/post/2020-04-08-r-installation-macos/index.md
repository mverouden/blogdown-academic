...
## Download 
At the time this post was written, the latest release of R was version 3.6.3. It has been updated to the latest release version 4.4.2 of R (nicknamed: "Pile of Leaves") for macOS Big Sur or higher.
...
- For macOS Big Sur (11.x) and higher (__Intel 64-bit__ build): [{{< icon name="download" pack="fas" >}} R 4.4.2  (ca. 96 MB, *notarized and signed* __Intel 64-bit__ build)](https://cloud.r-project.org/bin/macosx/big-sur-x86_64/base/R-4.4.2-x86_64.pkg)
- For macOS Big Sur (11.x) and higher (__Apple silicon arm64__ build for M1, M2 or M3 processor MACS only): [{{< icon name="download" pack="fas" >}} R 4.4.2  (ca. 94 MB, *notarized and signed* __ARM 64-bit__ build)](https://cloud.r-project.org/bin/macosx/big-sur-arm64/base/R-4.4.2-arm64.pkg) <!--Due to an error in the release for the Apple silicon arm64 build, use the above download for the Intel 64-bit version!-->
